        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Webpages</h4>
                </div>
                <div class="table-responsive width-95-per mx-auto">
                    <div class="dt-buttons float-end" style="margin-left: 20px; margin-top: 14px;">
                        <button class="dt-button add-new btn btn-success waves-effect waves-float waves-light" tabindex="0"
                            ...
                            onclick="window.location.href='/admin/addpage'">
                            <span>Add New</span>
                        </button>
                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="form-check form-switch form-check-success">
                                                <input name="is_publish" type="checkbox"
                                                    ...
                                                    data-id="{{ $data->id }}"
                                                    {{ $data->is_publish ? 'checked' : '' }} />
                                            </div>
                                        </div>
                                    </td>
                                    <td class="d-flex">
                                        <div>
                                            <a class="dropdown-item" href="/admin/editweb/{{ $data->id }}">
                                                <i data-feather="edit" class="font-medium-2 text-body me-50"></i>
                                            </a>
                                        </div>
                                        <div>
                                            <button class="btn btn-flat btn-sm remove-user" style="margin-top:2px;" data-id="{{ $data->id }}"
                                                data-action="{{ url('/web/del', $data->id) }}"
