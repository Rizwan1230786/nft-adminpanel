  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
          <h4 class="card-title">Sellers Link</h4>
      </div>
      <div class="table-responsive width-95-per mx-auto">
        <table class="table datatable">
          ...
          <tbody>
            ...
            <tr>
              <td class="count"></td>
              <td><img class="rounded-circle" src="{{ asset('uploads/seller-link/'.$clients->image) }}" alt="No image" height="30" width="30" style="margin-right:10px">
              {{$clients->fullname}}</td>
              <td>{{$clients->link}}</td>
            </tr>
            @endforeach
