        ...
        <table class="table datatable">
          ...
          <tbody>
            ...
            <tr>
              ...
              @if($clients->email && $clients->google_id && $clients->apple_id)
              <td>{{$clients->email}}</td>
              <td>{{$clients->google_id}}</td>
              <td>{{$clients->apple_id}}</td>
              @elseif($clients->email)
              <td>{{$clients->email}}</td>
              <td>No</td>
              <td>No</td>
              @elseif($clients->google_id)
              <td>No</td>
              <td>{{$clients->google_id}}</td>
              <td>No</td>
              @else
              ...
              <td>
                <div>
                  <button class="btn btn-flat btn-sm remove-user" style="margin-top:2px;" data-id="{{ $clients->id }}" data-action="{{ url('/client/delete',$clients->id) }}" onclick="deleteConfirmation({{$clients->id}})">
