            ...
            <div class="card">
                <div class="card-header">
                    ...
                    if (isset($users->id) && $users->id != 0) { ?>
                        <h4 class="card-title">Update {{$users->username ?? ''}} Customer</h4>
                            ...
                            <div class="col-12">
                                <div class="mb-1 row">
                                    <div class="col-sm-8 offset-2">
                                        <input type="text" class="form-control"  id="basic-default-name" name="fullname" value="{{$users->firstname ?? ''}}" placeholder="Enter Firstname" />

                                    </div>
                                    <div class="col-sm-8 offset-2 mt-1">
                                        <input type="text" class="form-control" name="username" value="{{$users->lastname ?? ''}}" placeholder="Enter Lastname"  />
                                    ...
                                    <div class="col-sm-8 offset-2 mt-1">
                                        <input type="date" class="form-control" name="dob" value="{{$users->dob ?? ''}}" placeholder="Enter Dob "  />
