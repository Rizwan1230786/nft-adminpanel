...
<head>
    ...
    <title>New Lead | Allset</title>
    <meta name="description" content="Contact Us | Allset App">
</head>
<style>
    .success{
     color: #74dc47;
                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="text-align:center;">
                           <a href="#" class="logo success"><b style="font-size: 35px;"><span></span>Allset</a>
                        </td>
                    </tr>
                    <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%; font-weight:500; color:rgba(0,0,0,.64)">
                                                        barber Name:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">{{($data["name"] ?? "--")}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%; font-weight:500; color:rgba(0,0,0,.64)">
                                                        Email:</td>
                                                ...
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed;border-right: 1px solid #ededed; width: 35%; font-weight:500; color:rgba(0,0,0,.64)">
                                                        Phone #:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">{{($data["contact"] ?? "--")}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 10px;  border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:rgba(0,0,0,.64)">
                                                        Message:</td>
                                                ...
                                                <tr>
                                                    <td style="padding: 10px;  border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:rgba(0,0,0,.64)">
                                                        Shop Name:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">{{($data["shop_name"] ?? "--")}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 10px;  border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:rgba(0,0,0,.64)">
                                                       Address:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">{{($data["address"] ?? "--")}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:#455056bd; line-height:18px; margin:0 0 0;">&copy; <strong>www.allset.com</strong></p>
                        </td>
                    </tr>
                </table>
            </td>
