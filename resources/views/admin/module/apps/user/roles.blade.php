    ...
    <div class="card">
      ...
      <div class="table-responsive width-95-per mx-auto">
        <div class="dt-buttons float-end" style="margin-left: 20px; margin-top: 14px;">
          <button class="dt-button add-new btn btn-success" tabindex="0" aria-controls="DataTables_Table_0" type="button" onclick="window.location.href='/admin/roles-create'">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="d-flex">
                ...
                <div>
                  <button class="btn btn-flat btn-sm remove-user dropdown-item" data-id="{{ $data->id }}" data-action="{{ url('/roles/delete',$data->id) }}" onclick="deleteConfirmation({{$data->id}})">
