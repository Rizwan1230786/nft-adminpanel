    ...
    <div class="card">
      ...
      <div class="table-responsive width-95-per mx-auto">
        <div class="dt-buttons float-end" style="margin-left: 20px; margin-top: 14px;">
          <button class="dt-button add-new btn btn-success" tabindex="0" aria-controls="DataTables_Table_0" type="button" onclick="window.location.href='/admin/adduser'">
        ...
        <table class="table datatable table-bordered">
          ...
          <tbody>
            ...
            <tr>
              <td class="count"></td>
              <td> <img class="rounded-circle" src="{{ asset('profile/'.$data->photo) }}" alt="No image" height="30" width="30" style="margin-right:10px">{{$data->fullname}}</td>
              <td>{{$data->email}}</td>
              <td>{{$data->role}}</td>
              <td>
