...
<nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center {{ $configData['navbarColor'] }}" data-nav="brand-center">
      ...
      <ul class="nav navbar-nav align-items-center ms-auto">
        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true">
            ...
            <span class="avatar">
             @if (Auth::check())
              <img src="{{ asset('profile/'.Auth::user()->photo) }}" alt="{{ Auth::user()->photo }}" height="40" width="40">
             @endif
          ...
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
            ...
            <a class="dropdown-item" href="{{ url('profile.show') ? url('profile.show') : 'javascript:void(0)' }}">
              <i class="me-50" data-feather="user"></i> {{ __('Profile')}}
            </a>
            <a class="dropdown-item cache-clear"  href="{{ url('/admin/clear') }}">
              <i class="me-50" data-feather="trash"></i> {{ __('Clear Cache')}}
            </a>
            <a class="dropdown-item" href="{{ url('/admin/signout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  {{-- Search Ends --}}
  @section('js')
    <script src="{{ asset('js/scripts/theamjquery/cacheclear/jquery.js') }}"></script>
  @endsection
  <!-- END: Header-->
